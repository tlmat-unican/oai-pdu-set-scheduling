...
// #include "../../sm/mac_sched_sm/ie/mac_sched_data_ie.h"
...
// int report_mac_sched_sm(global_e2_node_id_t* id, Interval inter, mac_cb* handler);
...
// void rm_report_mac_sched_sm(int);
