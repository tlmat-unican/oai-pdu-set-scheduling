...
#include "../../../../src/sm/kpm_sm/kpm_sm_v02.03/kpm_sm_agent.h"
#include "../../../../src/sm/kpm_sm/kpm_sm_v02.01/kpm_sm_ric.h"
#include "../../../../src/sm/kpm_sm/kpm_sm_v02.01/ie/kpm_data_ie.h"
#include "../../../../src/sm/kpm_sm/kpm_sm_v02.01/kpm_sm_id.h"
...
// check_ric_service_update(sm_ag, sm_ric);
  ...
  printf("Key Performance Metric (KPM-SM) version 2.0 Release 1 run with success\n");
  return EXIT_SUCCESS;
}
