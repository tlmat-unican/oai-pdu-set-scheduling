...
#define GNB_CONFIG_STRING_DL_SCHEDULER                  "dl_scheduler"
...
#define GNB_CONFIG_HLP_DL_SCHEDULER                     "DL scheduler selection: pf or custom"
...
{GNB_CONFIG_STRING_DL_SCHEDULER, GNB_CONFIG_HLP_DL_SCHEDULER, 0,       .strptr=NULL,.defstrval="pf",             TYPE_STRING,    0},  \
}
// clang-format on
...
#define GNB_DL_SCHEDULER_IDX            39
